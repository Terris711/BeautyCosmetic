		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-sm-12">
					<div class="sign-in">
						<p style="text: 14px">
							This is the first time you log in, please <a style="color: pink,"
								href="register.jsp">register</a>.
						</p>
						<form action="ForgetPass" id="form-signin" method="post">
							...
							<input type="submit" value="Get Password" class="form-submit">
